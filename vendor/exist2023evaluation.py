...
"""
        ...
        The formats of the system output as well as a description of the evaluation methodology is provided 
...
def main(argv):
    ...
    for opt, arg in opts:
        if opt == '-h':
            print ('exist2023evaluation.py -p <prediction_file> -g <gold_file> -e <gold_hard_file> -t task_name')
            sys.exit()
        elif opt in ("-p", "--pfile"):
            pred_file = arg.strip()
        elif opt in ("-g", "--gfile"):
